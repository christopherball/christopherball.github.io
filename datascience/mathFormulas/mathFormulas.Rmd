...
**Formula Source**:
    ...
    log_color(red)bcolor(blue)x=color(green)y hArrcolor(red)b^color(green)y=color(blue)x

    log_(color(red)b)(color(red)b^color(blue)x)=color(blue)x\ " for every"\ color(blue)x in RR

    color(red)b^(log_color(red)bcolor(blue)x)=color(blue)x\ " for every"\ color(blue)x>0

    log_color(red)b(color(blue)xcolor(green)y)=log_color(red)bcolor(blue)x+log_color(red)bcolor(green)y

    log_color(red)b(color(blue)x/color(green)y)=log_color(red)bcolor(blue)x-log_color(red)bcolor(green)y

    log_color(red)b(color(blue)x^color(green)r)=color(green)rlog_color(red)bcolor(blue)x\ " for every"\ color(green)r in RR

    log_ecolor(red)x=lncolor(red)x

    lncolor(red)x=color(blue)y hArre^color(blue)y=color(red)x

    ln(e^color(red)x)=color(red)x\ " for every"\ color(red)x in RR

    e^lncolor(red)x=color(red)x\ " for every"\ color(red)x>0

    lne=1

    log_color(red)bcolor(blue)x=lncolor(blue)x/lncolor(red)b\ " for every"\ color(red)b>1
